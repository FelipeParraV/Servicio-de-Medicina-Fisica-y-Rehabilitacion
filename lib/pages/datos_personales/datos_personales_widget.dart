...
export 'datos_personales_model.dart';
...
class _DatosPersonalesWidgetState extends State<DatosPersonalesWidget> {
  ...
  void initState() {
    ...
    _model.rutFieldController ??= TextEditingController();
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 0.0),
                              child: TextFormField(
                                controller: _model.apellidoFieldController,
                                onFieldSubmitted: (_) async {
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 0.0),
                              child: TextFormField(
                                controller: _model.rutFieldController,
                                onFieldSubmitted: (_) async {
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                                ...
                                style: FlutterFlowTheme.of(context).bodyMedium,
                                validator: _model.rutFieldControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FlutterFlowRadioButton(
                          ...
                          controller: _model.sexoRadioValueController ??=
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 0.0),
                              child: TextFormField(
                                controller: _model.telefonoFieldController,
                                onFieldSubmitted: (_) async {
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 0.0),
                              child: TextFormField(
                                controller: _model.direccionFieldController,
                                onFieldSubmitted: (_) async {
                                  if (_model.formKey.currentState == null ||
                                      !_model.formKey.currentState!
                                          .validate()) {
                                ...
                                onPressed: () async {
                                  ...
                                  FFAppState().update(() {
                                    ...
                                    FFAppState().listaRuts2 =
                                        _model.rutFieldController.text;
                                    FFAppState().listaFechas2 =
                                        _model.datePicked;
                                    FFAppState().listaSexos2 =
                                        _model.sexoRadioValue!;
                                  });
                                  if (_model.telefonoFieldController.text ==
                                          null ||
                                      _model.telefonoFieldController.text ==
                                          '') {
                                    FFAppState().update(() {
                                  ...
                                  if (_model.direccionFieldController.text ==
                                          null ||
                                    ...
                                    FFAppState().update(() {
                                      FFAppState().direccionCheck = true;
                                    });
                                    FFAppState().update(() {
                                      FFAppState().listaDirecciones2 =
                                          _model.direccionFieldController.text;
